...
internal class LinuxTunController(
    ...
    suspend fun start(
        ...
        val config = writeConfig(socksPort, socksUsername, socksPassword, upScript, downScript)
        ...
        fun configContent(
            ...
            return buildString {
                ...
                if (socksUsername.isNotBlank()) {
                    appendLine("  username: ${socksUsername.yamlValue()}")
                    appendLine("  password: ${socksPassword.yamlValue()}")
                }
                appendLine("  udp: 'tcp'")
