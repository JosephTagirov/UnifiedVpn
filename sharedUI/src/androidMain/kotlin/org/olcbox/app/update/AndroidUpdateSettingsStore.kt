...
class AndroidUpdateSettingsStore(context: Context) : AppUpdateSettingsStore {
    ...
    override suspend fun load(): AppUpdateSettings {
        ...
        return AppUpdateSettings(
            ...
            lastSeenOlcboxRelease = preferences.getString(KEY_LAST_SEEN_OLCBOX, null),
            lastSeenAmneziaRelease = preferences.getString(KEY_LAST_SEEN_AMNEZIA, null)
        ).normalized()
    }
    ...
    override suspend fun save(settings: AppUpdateSettings) {
        ...
        preferences.edit()
            ...
            .putString(KEY_LAST_SEEN_OLCBOX, normalized.lastSeenOlcboxRelease)
            .putString(KEY_LAST_SEEN_AMNEZIA, normalized.lastSeenAmneziaRelease)
            .apply()
    }
