...
| Windows x86-64 | system proxy, local SOCKS, optional TUN | bundled `olcrtc`, `sing-box`, `tun2socks`, and Wintun runtimes |
...
| Windows EXE installer | `.\gradlew.bat :desktopApp:packageReleaseExe` |
