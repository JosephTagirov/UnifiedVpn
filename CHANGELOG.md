...
- Если один GitHub-релиз содержит несколько файлов одной версии, приложение выбирает максимальный build внутри предпочтительного для платформы типа файла, а не первый asset из ответа GitHub API.
